...
//		int raw, msb, lsb, xlsb;
	...
	public int readPressure() throws IOException, InterruptedException {
	...
	public double readAltitude() throws IOException, InterruptedException {
		...
		return 44330.0 * (1.0 - Math.pow(readPressure() / 101325, 0.1903));
	}

	public double readAltitude(int seaLevelPressure) throws IOException,
			InterruptedException {
		// "Calculates the altitude in meters"
		return 44330.0 * (1.0 - Math.pow(readPressure() / seaLevelPressure,
				0.1903));
	}
