...
public class AdafruitL3GD20 {
	...
	private final ArrayList<Double> dataRateValues = new ArrayList<Double>() {
	...
	private final HashMap<Double, HashMap<Double, Integer>> DRBW = new HashMap<Double, HashMap<Double, Integer>>() {
	...
	private final HashMap<Double, HashMap<Double, Integer>> HPCF = new HashMap<Double, HashMap<Double, Integer>>() {
...
//		byte[] buffer = new byte[256];
		try {
//			current = device.read(register,buffer,0,255); // Get current value
			current = device.read(register); // Get current value
//			System.out.println("Register: " + register + ", " + mask + ", " + "Current: " + current);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void calibrateX() {
		...
		for (int t = 0; t < 20; t++) {
//			System.out.println(getAxisDataAvailableValue().get(0));
	...
	public void printConfiguration(){
		...
		for(String r: config.keySet()){
			System.out.println(r + "\t" + config.get(r));
		}
//		return config;
	}
	...
	public void setHighPassCutOffFreq(double freq) {
	 ...
	 */
	public String getPushPullOrOpenDrainValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG3,
	 ...
	 */
	public String getFullScaleValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG4,
	 ...
	 * Big/Little endian
	 */
	public String getBigLittleEndianValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG4,
	 ...
	 * Block data update
	 */
	public String getBlockDataUpdateValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG4,
	 ...
	 * Boot mode
	 */
	public String getBootModeValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG5,
	 ...
	 */
	public String getINT1SelectionValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG5,
	 ...
	 */
	public String getOutSelectionValue() {
		return (String) readFromRegisterWithDictionaryMatch(REG_RW_CTRL_REG5,
	...
	private ArrayList<Integer> getAxisDataAvailableValue() {
		...
		int yda = 0;
		int xda = 0;
//		System.out.println(readFromRegister(REG_R_STATUS_REG, MASK_STATUS_REG_ZYXDA));
	 ...
	 * Fifo mode
	 */
	public String getFifoModeValue() {
		return (String) readFromRegisterWithDictionaryMatch(
	 ...
	 * Fifo empty
	 */
	public boolean getIsFifoEmptyValue() {
	 ...
	 */
	public String getInt1CombinationValue() {
		return (String) readFromRegisterWithDictionaryMatch(
